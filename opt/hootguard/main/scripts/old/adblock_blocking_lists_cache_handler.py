...
def fetch_with_cache(cache_key, url):
    ...
    # Log the generated cache path
    #logger.info(f"INFO - Generated cache file path: {cache_file}, {CACHE_DIR}")
    ...
    try:
        ...
        logger.debug(f"INFO - Data cached successfully for key: {cache_key}")
        return cache_file
        #return data
