...
#    DDNS_HOOTGUARD_CLOUDFLARE_COMMAND, 
#    DDNS_USER_CLOUDFLARE_COMMAND, 
#    DDNS_USER_CLOUDFLARE_V6_COMMAND, 
#    DDNS_USER_DUCKDNS_COMMAND, 
#    DDNS_USER_DUCKDNS_V6_COMMAND
#)
...
DDNS_HOOTGUARD_CLOUDFLARE_COMMAND = config['ddns']['hootguard_cloudflare_command']
DDNS_USER_CLOUDFLARE_COMMAND = config['ddns']['user_cloudflare_command']
...
def ddns_update_crontab(ddns_type):
    ...
    ddns_commands = {
        'hootguard-cloudflare': (DDNS_HOOTGUARD_CLOUDFLARE_COMMAND, 'DDNSUpdate'),
