...
def initial_setup_summary():
    # Render the setup page
    return render_template('initial_setup/initial_setup_summary.html', ip_addr=session['ip_address'], subnet=session['subnet_mask'], gateway=session['standard_gateway'], ddns=session['ipversion'], password=session['setup_password'] )
